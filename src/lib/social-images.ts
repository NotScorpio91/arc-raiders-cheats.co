...
const PAGE_SOCIAL_IMAGES: Record<string, SocialImage> = {
  ...
  '/cheats/private/': shot(1, 'ARC Raiders Private cheat — Viper in-house build'),
  '/products/': shot(4, 'Arc Raiders products — Cloud DMA, UGC, Skin Changer, and HWID Spoofer'),
  '/products/ugc/': shot(4, 'Arc Raiders UGC account recovery tools'),
  '/products/skin-changer/': shot(5, 'Skin Changer — unlock weapon skins and cosmetics'),
